...
const EventsSection = () => {
  ...
  velocity={velocity} 
  className="mx-10 mb-10 mt-0 px-0 py-0 custom-scroll-text text-2xl md:text-4xl text-black"
/>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-12">
          <div>
            <h2 className="text-3xl mt-10 md:text-4xl font-bold text-gray-900 mb-4">
              Guest Reveal Video 
            </h2>
        ...
        <div className="flex flex-col md:flex-row gap-8 relative">
          <div className="w-full md:w-2/3 relative">
            ...
            <Button
              onClick={toggleMute}
              className="absolute top-4 right-4 bg-white p-2 rounded-full text-club-blue"
            >
